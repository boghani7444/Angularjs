...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
            ...
            main: {
                files: [{
                  ...
                  dest: 'dist/css'
                    ...
                    expand: true,
                    dot: true,
                    cwd: 'bower_components/ngImgCropFullExtended/compile/minified',
                    src: ['ng-img-crop.css'],
                    dest: 'dist/css'
                },{
                    //for Angular Material stylesheet files
            ...
            combine: {
                files: {
                    'dist/css/main.css': [
                        ...
                        'bower_components/angular-trix/dist/trix.css',
                        //'bower_components/angular-redactor/redactor.min.css',
                        'styles/styles.css',
                        'styles/custom/_override.css',
						'bower_components/textAngular/dist/textAngular.css','bower_components/ng-cropper/dist/ngCropper.all.min.css',
						'bower_components/angular-twh-rating-stars/dist/twh-rating-stars.css'
                    ]
                }
            },
            add_banner: {
        ...
        html2js: {
            dist: {
                src: [ 'app/views/*.html',
				//'app/views/charts/*.html','app/views/forms/*.html','app/views/mail/*.html','app/views/maps/*.html',
				'app/views/pages/*.html',//'app/views/tables/*.html','app/views/tables/*.html','app/views/tasks/*.html','app/views/ui_elements/*.html' 
				],
                dest: 'tmp/views.js'
            }
        },
        ...
        concat: {
            ...
            dist: {
                src: [
					//'scripts/gmap.js',
                    'bower_components/slimScroll/jquery.slimscroll.min.js','bower_components/angular/angular.min.js',
                    ...
                    'bower_components/flash/dist/angular-flash.min.js',
                   ...
                   // 'bower_components/easypie/dist/angular.easypiechart.js',
                    ...
                    'bower_components/any-loader-ng/dist/any-loader-ng.min.js', 
                    'bower_components/angular-filereader/angular-filereader.js',
                    //'bower_components/angular-filereader/src/filereader.service.js',    
                    'bower_components/angular-file-reader/angular-file-reader.js',//'bower_components/angular-cropper/angular-cropper.js',
                    //'bower_components/ng-jcrop/jquery.Jcrop.min.js',
					//'bower_components/ng-jcrop/ng-jcrop.js',                    
                    //'bower_components/angular-file-upload/dist/angular-file-upload.js',
                    //'bower_components/ngImgCropFullExtended/compile/unminified/ng-img-crop.js',//'bower_components/ng-file-upload/ng-file-upload-all.min.js',               //'bower_components/ng-file-upload/ng-file-upload-shim.min.js',              //'bower_components/tinymce-dist/plugins/print/plugin.js',                   //'bower_components/angular-ui-tinymce/src/tinymce.js',                      
					'bower_components/textAngular/dist/textAngular-rangy.min.js',
					'bower_components/textAngular/dist/textAngular-sanitize.min.js',
					'bower_components/textAngular/dist/textAngular.min.js',
					//'scripts/other_charts.js',
					//'bower_components/angular-moment/angular-moment.js',
					'bower_components/angular-twh-rating-stars/dist/twh-rating-stars.js',
					'bower_components/moment/moment.js',
					'bower_components/ng-cropper/dist/ngCropper.all.min.js',
                                        'bower_components/angular-trix/dist/trix.js',
                                        'bower_components/angular-trix/dist/angular-trix.min.js',
                                       // 'bower_components/angular-redactor/redactor.min.js',
